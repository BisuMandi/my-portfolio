...
const skills = ["React", "JavaScript", "Node.js", "Tailwind CSS", "MongoDB", "Express", "Git", "GitHub Actions"];
    ...
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            <div className="absolute inset-0">
                <img
                    src="/hero-bg.jpg" alt="Hero Image"
            ...
            <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="animate-fade-in">
                            <span className="inline-flex items-center gap-2 px-4 py2 rounded-full glass text-sm text-primary">
                                ...
                                Software Developer - Java Specialist
                            </span>
                        </div>

                        {/* Headline */}
                        <div className="space-y-4">
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100ms">
                                Crafting <span className="text-primary glow-text">Digital</span>
                                <br />
                                experiences with
                                <br />
                                <span className="font-serif italic text-normal text-white">precision</span>
                            </h1>
                    ...
                    <div className='relative animate-fade-in animation-delay-300'>
                        {/* Profile Image */}
                        <div className='relative mx-w-md mx-auto'>
                            <div
                            ...
                            <div className='relative glass rounded-3xl p-2 glow-border'>
                                ...
                                />
                                {/* Floating Badge */}
                                <div className='absolute -bottom-4 -right-4 rounded-xl px-4 py-3 glass animate-float'>
                                ...
                                {/* Stats Badge */}
                                <div className='absolute -top-4 -left-4 rounded-3xl px-4 py-3 glass animate-float animation-delay-500'>
            ...
            >
                <a
                    href="#about" className="flex flex-col items-center gap-2 text-muted-foreground hover:text-primary transition-colors group"
                >
